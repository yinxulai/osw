  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-6 px-6 py-3.5">
        ...
        {/* 锚点导航只在宽屏出现：窄屏塞进去会把顶栏挤成两行，价值也不大。 */}
...
/** GitHub 标记。Simple Icons 的官方路径（CC0），单色继承 `currentColor`。 */
interface GitHubMarkProps {
  className?: string
}

export function GitHubMark(params: GitHubMarkProps) {
